...
namespace LepecydLanches.Migrations
{
    ...
    public partial class PopularLanches : Migration
    {
        ...
        {
            mb.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque," +
            ...
            mb.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl," +
                "ImagemUrl,IsLanchePreferido,Nome,Preco) " +
